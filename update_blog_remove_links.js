...
async function run() {
  ...
  // Remove the Internal Linking Placeholders section
  const sectionToRemove = /<h2>➤ Internal Linking Placeholders<\/h2>[\s\S]*?<\/ul>/;
  ...
  if (patchRes.ok) {
    console.log('Successfully removed the internal linking placeholders section.');
  } else {
